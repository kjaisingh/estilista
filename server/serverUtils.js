...
const getMidjourneyPrompt = (prompt_context, user_profile_img, channel) => {
    ...
    let prompt = `/imagine ${profile_img_string}${item_urls} Individual wearing all clothing items provided. Full body, 8k quality, hyper-realistic render. Canon EOS R6 Mark II Mirrorless Camera. Include full background. Frontal perspective. ${prompt_context_string} ${item_weights} --version 5`;
    return prompt;
}
